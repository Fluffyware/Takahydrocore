...
const equipmentSplitPageTranslationOverrides = {
  en: {
    ...
    geophysical: [
      ...
      ['meta[name="description"]', 'PT Taka Hydrocore Indonesia geophysical equipment showcase for bathymetry, seabed mapping, seismic acquisition, positioning, oceanographic, and survey data control systems.'],
      ...
      ['.equipment-overview-copy .kicker', 'Geophysical systems'],
      ...
      ['.equipment-overview-copy>p:not(.kicker)', 'A compact overview of geophysical equipment used to support bathymetry, seabed mapping, seismic acquisition, positioning, oceanographic measurement, visual inspection, and onboard QC.'],
      ['.geophys-showcase-section>.section-label', '<span>02</span> Equipment Showcase', 'html'],
      ['.geophys-showcase-head .kicker', 'Geophysical Equipment']
    ]
  },
  id: {
    geotechnical: [
    ...
    geophysical: [
      ...
      ['meta[name="description"]', 'Showcase peralatan geofisika PT Taka Hydrocore Indonesia untuk bathymetry, pemetaan seabed, akuisisi seismik, positioning, oceanographic, dan kontrol data survei.'],
      ...
      ['.equipment-overview-copy .kicker', 'Sistem geofisika'],
      ...
      ['.equipment-overview-copy>p:not(.kicker)', 'Ringkasan compact peralatan geofisika untuk bathymetry, pemetaan seabed, akuisisi seismik, positioning, pengukuran oceanographic, inspeksi visual, dan QC onboard.'],
      ['.geophys-showcase-section>.section-label', '<span>02</span> Showcase Peralatan', 'html'],
      ['.geophys-showcase-head .kicker', 'Peralatan Geofisika']
    ]
  }
};
