...
const boardPageTranslations = {
  en: [
    ...
    ['.board-card:nth-child(2) .board-bio', 'Syukri Fitrialdi was born in Padang in 1968 and completed bachelor and master studies at Institut Teknologi Bandung (ITB).'],
  ...
  id: [
    ...
    ['.board-card:nth-child(2) .board-bio', 'Syukri Fitrialdi lahir di Padang pada 1968 dan menyelesaikan pendidikan sarjana serta magister di Institut Teknologi Bandung (ITB).'],
...
const applyBoardLanguage = (language) => {
  ...
  const boardPageTranslationsV2 = {
    en: [
      ...
      ['.board-profile-group:nth-of-type(1) .board-profile:nth-of-type(1) .board-profile-name h3', 'Syukri Fitrialdi'],
      ['.board-profile-group:nth-of-type(1) .board-profile:nth-of-type(1) .board-bio', 'Syukri Fitrialdi was born in Padang in 1968. He earned both his bachelor\'s and master\'s degrees from Institut Teknologi Bandung (ITB). Known for his intelligence, professionalism, and sense of humor, he has built more than three decades of experience in geotechnical and geohydrological work, deep water well drilling, deep exploratory drilling, water well drilling and pumping, and onshore, offshore, and nearshore geotechnical investigation.'],
    ...
    id: [
      ...
      ['.board-profile-group:nth-of-type(1) .board-profile:nth-of-type(1) .board-profile-name h3', 'Syukri Fitrialdi'],
      ['.board-profile-group:nth-of-type(1) .board-profile:nth-of-type(1) .board-bio', 'Syukri Fitrialdi lahir di Padang pada 1968. Ia menyelesaikan pendidikan sarjana dan magister di Institut Teknologi Bandung (ITB). Dikenal cerdas, profesional, dan humoris, ia memiliki pengalaman lebih dari tiga dekade dalam bidang geotechnical dan geohydrological, deep water well drilling, deep exploratory drilling, water well drilling and pumping, serta investigasi geoteknik onshore, offshore, dan nearshore.'],
